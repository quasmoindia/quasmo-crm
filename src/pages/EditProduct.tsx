    ...
    <div className="mx-auto max-w-5xl">
      ...
      <div className="mb-4 flex flex-col gap-3 sm:mb-6 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <h1 className="mt-2 text-xl font-bold text-slate-800 sm:text-2xl">Edit Product</h1>
          <p className="mt-1 text-xs text-slate-500 sm:text-sm">{product.productCode}</p>
        </div>
